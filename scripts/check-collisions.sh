...
checks=(
    ...
    "main_notch_nominal_clearance empty"
    "main_battery empty"
    "main_pcb empty"
    "main_pcb_front_axial_retention nonempty"
    "main_pcb_service_keepouts empty"
    "main_switch empty"
    ...
    "lid_pcb_fixed_retention nonempty"
    "lid_pcb_rear_retention nonempty"
    "lid_pcb_rear_axial_retention nonempty"
    "lid_pcb_service_keepouts empty"
    "lid_switch empty"
